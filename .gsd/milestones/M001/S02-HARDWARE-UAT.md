...
| H05 | Wheel mapping | Physical direction, event names, rate, rapid ticks, boundaries, feedback latency measured | PENDING | - | Owner-observed: highlight moved opposite to the wheel and was over-sensitive. Applied device calibration (invert scrollUp/scrollDown + 80ms throttle) and added click-tone + haptic feedback on item change (Rabbit host); reinstall ?v=9 and re-confirm direction, feel, and feedback |
